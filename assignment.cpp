...
int main(){
    ...
    int op;
    do {
        cout<<"1)Lab Task 1: Write an application using Stack that checks whether the entered string of brackets is balanced, e.g.[{( )}] is Balanced while {[( )] } is not Balanced because the priority of the parenthesis is not maintained."<<endl;
